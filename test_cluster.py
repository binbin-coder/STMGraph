...
parser.add_argument("--input-ground-true", type=str, default="/share/home/stu_qilin/project/HumanPilot-master/outputs/SpatialDE_clustering/cluster_labels_151674.csv", help="Path to the input ground truth file")
...
parser.add_argument("--output-file", type=str, default="/share/home/stu_qilin/software/STMGrpah/output_151674/", help="Directory path for output files")

...
parser.add_argument("--num-cluster", type=int, default=11, help="Number of clusters to form")
parser.add_argument("--rad-cutoff", type=int, default=50, help="SNG cover radius")
...
parser.add_argument("--output-dir", type=str, default="/share/home/stu_qilin/software/STMGraph2/output_mouse_olfactory_bulb_Slide", help="Directory path for output files")
...
sc.pl.embedding(adata, basis="spatial", color="log1p_total_counts",s=6, show=False, title='mouse olfactory bulb')
plt.axis('off')
plt.savefig(output_dir+"/Mouse_Olfactory_raw.png", dpi=100)
plt.close()

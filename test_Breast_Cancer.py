...
parser.add_argument("--input-ground-true", type=str, default="/share/home/stu_qilin/software/stdata/Human_Breast_Cancer/metadata.tsv", help="Path to the input ground truth file")
parser.add_argument("--input-dir", type=str, default="/share/home/stu_qilin/software/stdata/Human_Breast_Cancer", help="Directory path for input data")
parser.add_argument("--count-file", type=str, default="/share/home/stu_qilin/software/stdata/Human_Breast_Cancer/V1_Breast_Cancer_Block_A_Section_1_filtered_feature_bc_matrix.h5", help="Path to the count file")
parser.add_argument("--output-file", type=str, default="/share/home/stu_qilin/software/STMGraph/output_Breast_Cancer/", help="Directory path for output files")

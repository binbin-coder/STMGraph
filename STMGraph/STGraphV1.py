...
class STGraph():
    ...
    def __init__(self, hidden_dims, n_epochs=500, lr=0.0001,alpha=0.2,
        ...
        self.sgate = SGATE(hidden_dims, nonlinear, weight_decay, alpha)
        self.loss, self.H, self.C, self.ReX = self.sgate(self.A, self.X, self.mask_ratio, self.noise)
